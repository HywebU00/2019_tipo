      ...
      <div class="container">
        ...
        <section class="investigation">
          ...
          <div class="right_block">
            <!-- h2節點 -->
            <h2 class="title">相關函釋 sp3_3 專區_cp1一般內容頁</h2>
            <!-- function功能區塊 -->
            <?php require_once('include/function.html'); ?>
            <!-- CP Start -->
            <section class="cp">
              <div class="cp_pic" data-caption="第一張圖說">
                <img src="https://assets.imgix.net/examples/balloons.jpg?w=400&amp;auto=format%2Cenhance" alt="balloons" class="float_left">
              </div>
