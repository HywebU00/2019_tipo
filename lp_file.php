  ...
  <div class="wrapper">
    ...
    <div id="center" class="main innerpage">
      ...
      <div class="container">
        ...
        <!-- h2節點 -->
        <h2 class="title">智慧財產權月刊資料檢索-lp5附件下載列表頁</h2>
        <!-- function功能區塊 -->
            ...
            <table summary="">
              ...
              <tbody>
                <tr>
                  ...
                  <td data-title="類別" class="brand">未分類</td>
                ...
                <tr>
                  ...
                  <td data-title="類別" class="brand">專利</td>
                  <td data-title="標題" class="num">智慧財產權月刊第244期</td>
                  <td data-title="期別" class="number">244</td>
                  <td data-title="作者"><a href="#">郭彥鋒,簡大翔,莊宗翰,吳家豪</a></td>
                  <td data-title="電子書" class="center"></td>
                ...
                <tr>
                  ...
                  <td data-title="類別" class="brand">商標</td>
                  <td data-title="標題" class="num">智慧財產權月刊第244期</td>
                  <td data-title="期別" class="number">244</td>
                  <td data-title="作者"><a href="#">郭彥鋒,簡大翔,莊宗翰,吳家豪</a></td>
                  <td data-title="電子書" class="center"></td>
                ...
                <tr>
                  ...
                  <td data-title="類別" class="brand">判決摘要</td>
                  <td data-title="標題" class="num">智慧財產權月刊第244期</td>
                  <td data-title="期別" class="number">244</td>
                  <td data-title="作者"><a href="#">郭彥鋒,簡大翔,莊宗翰,吳家豪</a></td>
                  <td data-title="電子書" class="center"></td>
                ...
                <tr>
                  ...
                  <td data-title="類別" class="brand">國際智財新訊</td>
                  <td data-title="標題" class="num">智慧財產權月刊第244期</td>
                  <td data-title="期別" class="number">244</td>
                  <td data-title="作者"><a href="#">郭彥鋒,簡大翔,莊宗翰,吳家豪</a></td>
                  <td data-title="電子書" class="center"></td>
